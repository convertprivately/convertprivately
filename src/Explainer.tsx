...
return(
  <div className="flex flex-col mx-auto max-w-[900px] pb-20 px-6">
...
<div className="flex flex-col sm:flex-row justify-between max-w-screen-lg mx-auto sm:my-8">
      ...
      <div className="flex flex-col p-4">
        ...
        <p className="mt-4 text-sm text-zinc-300">
        PrivateConverter is a free tool. We don’t charge for conversions and we don’t have any ads.        </p>
      </div>
      ...
      <div className="flex flex-col p-4">
        ...
        <p className="mt-4 text-sm text-zinc-300">
        The software behind PrivateConverter is open source. You can check the GitHub page here.        </p>
      </div>
</div>
      </div>
  );
