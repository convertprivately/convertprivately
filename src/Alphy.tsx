...
<div className="flex flex-col items-center">
    ...
    <div className="flex flex-col lg:flex-row ">
            ...
            <div className={`   flex  flex-row items-center overflow-x-scroll scroll-smooth carousel-area pl-6 pr-2 `} ref={carouselRef}>
                                                ...
                                                <button onClick={scrollForward}  type="button" className={` right-arrow w-[20px]  hidden md:block my-auto flex items-center justify-center h-full cursor-pointer group focus:outline-none bg-transparent outline-none border-0 focus:border-0 focus:ring-0 ${
                                                                                                                            ""
                                                                                                                            }`}>
